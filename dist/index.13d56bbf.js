...
},{"./struct/user":"5M7RE","core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib"}],"5M7RE":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "User", function () {
  return User;
});
_parcelHelpers.export(exports, "currentUser", function () {
  return currentUser;
});
...
var _controllerTransferJs = require("./controller/transfer.js");
var _controllerTransferJsDefault = _parcelHelpers.interopDefault(_controllerTransferJs);
var _controllerLogout = require('./controller/logout');
var _controllerLogoutDefault = _parcelHelpers.interopDefault(_controllerLogout);
...
class User {
  ...
  userLogin() {
    html.btnLogin.addEventListener('click', e => {
      e.preventDefault();
      currentUser = _controllerLoginJs.login(html.inputLoginUsername.value, html.inputLoginPin.value);
    });
  }
  makeTransfer() {
    html.btnTransfer.addEventListener('click', e => {
      e.preventDefault();
      _controllerTransferJsDefault.default(Number(html.inputTransferAmount.value), Number(html.inputTransferTo.value));
    });
  }
  logOut() {
    html.btnLogOut.addEventListener('click', _controllerLogoutDefault.default);
  }
}
;

},{"./helper/helperfunc.js":"3tc7X","./html.js":"1vBA1","./store":"1jgH9","./accounts.js":"18vnr","./controller/register.js":"4bQox","./controller/login.js":"7oMYB","./controller/transfer.js":"4JNDl","./controller/logout":"2TZWT","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3tc7X":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"sweetalert2":"65nX0","../html":"1vBA1","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"65nX0":[function(require,module,exports) {
var define;
/*!
...
},{}],"1vBA1":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{}],"1jgH9":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class Store {
  currentUser;
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4bQox":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"./html":"1vBA1","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"7oMYB":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
var _uiJsDefault = _parcelHelpers.interopDefault(_uiJs);
var _sweetalert = require("sweetalert2");
var _sweetalertDefault = _parcelHelpers.interopDefault(_sweetalert);
var _storeJs = require('../store.js');
var _storeJsDefault = _parcelHelpers.interopDefault(_storeJs);
var _user = require('../user');
var _userDefault = _parcelHelpers.interopDefault(_user);
const html = new _htmlJs.Html();
const ui = new _uiJsDefault.default();
const store = new _storeJsDefault.default();
function login(userName, userPin) {
  let currentUser = store.getCurrentUser(_userDefault.default, html.inputLoginUsername.value);
  ...
  store.saveAllUsers(_userDefault.default);
  // console.log(allUsers);
  return currentUser;
}

},{"../html.js":"1vBA1","sweetalert2":"65nX0","../store.js":"1jgH9","../user":"5M7RE","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","../ui.js":"2qKU6"}],"2qKU6":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _htmlJs = require("./html.js");
var _sweetalert = require("sweetalert2");
var _sweetalertDefault = _parcelHelpers.interopDefault(_sweetalert);
var _modalJs = require('./modal.js');
let html = new _htmlJs.Html();
let modal = new _modalJs.Modal(html.btnSignupOpenModal, html.btnLoginOpenModal);
class UI {
...
},{"./html.js":"1vBA1","sweetalert2":"65nX0","./modal.js":"50qz6","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4JNDl":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _helperHelperfunc = require('../helper/helperfunc');
var _html = require('../html');
var _uiJs = require('../ui.js');
var _uiJsDefault = _parcelHelpers.interopDefault(_uiJs);
var _user = require('../user');
...
var _storeDefault = _parcelHelpers.interopDefault(_store);
const html = new _html.Html();
const helperFunc = new _helperHelperfunc.Helper();
const ui = new _uiJsDefault.default();
const store = new _storeDefault.default();
function transfer(transferAmount, receiverAcc) {
  let transactionOTP = helperFunc.generateOTP();
  // find where receiver accountNo is equal to sender input;
  let receiverDetail = _userDefault.default.map(user => user.acc).flat().find(acc => acc.accNumber === receiverAcc);
  ...
  let currentUserAcc = _user.currentUser.acc.find(acc => acc.mov);
  ...
  if (transferCondition && receiverDetail) {
    ...
    _userDefault.default.forEach(user => {
      if (user.userFullName === _user.currentUser.userFullName) {
        ...
        if (maxBalanceCheck && transactionOTP) {
          ...
          _sweetalertDefault.default.fire({
            ...
            if (fulfiled.isConfirmed && fulfiled.value === transactionOTP) {
              ...
              store.saveAllUsers(_userDefault.default);
              console.log(_userDefault.default);
              console.log(currentUserAcc);
              // update UI
              ui.updateUI(_user.currentUser);
              // clearField
...
},{"../helper/helperfunc":"3tc7X","../html":"1vBA1","../user":"5M7RE","sweetalert2":"65nX0","../store":"1jgH9","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","../ui.js":"2qKU6"}],"2TZWT":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _html = require('../html');
const html = new _html.Html();
...
},{"../html":"1vBA1","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1PFvP":[function(require,module,exports) {
...
},{}]},["2Mlp2","6Ctme"], "6Ctme", "parcelRequire223e")

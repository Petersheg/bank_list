...
// ///////////////////////////////////////////////
const auser = new _modulesUserJs.Auser(_modulesUserJs.accounts);

},{"./modules/user.js":"3r5kQ","core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib"}],"3r5kQ":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "Auser", function () {
  return Auser;
});
_parcelHelpers.export(exports, "accounts", function () {
  return accounts;
});
...
const modal = new _modalJs.Modal(btnSignupOpenModal, btnLoginOpenModal);
let currentUser, sorted = false;
class Auser {
  // Get registered users from local storage.
  #undefined = JSON.parse(localStorage.getItem('Users')) || [];
  ...
  userLogin() {
    btnLogin.addEventListener('click', e => {
      ...
      currentUser = this.#undefined.find(acc => acc.userName === inputLoginUsername.value) || [];
  ...
  userTransfer() {
    btnTransfer.addEventListener('click', e => {
      ...
      let receiverDetail = this.#undefined.find(acc => String(acc.accountNumber) === receiverAcc);
      ...
      let transferCondition = currentUser.balance >= transferAmount && receiverAcc && receiverAcc !== String(currentUser.accountNumber) && transferAmount > 0;
            ...
            if (maxBalanceCheck && transactionOTP) {
              ...
              _sweetalertDefault.default.fire({
                ...
                if (fulfiled.isConfirmed && fulfiled.value === transactionOTP) {
                  ...
                  const dateAndTime = _modalJs.signUp.timeStamp();
                  ...
                  localStorage.setItem('Users', JSON.stringify(this.#undefined));
                  // update UI
                  newAccount.updateUI(currentUser);
                  // clearField
...
},{"./modal.js":"4rHhP","./account.js":"3zElt","sweetalert2":"65nX0","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4rHhP":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "Modal", function () {
  return Modal;
});
_parcelHelpers.export(exports, "signUp", function () {
  return signUp;
});
var _sweetalert = require("sweetalert2");
var _sweetalertDefault = _parcelHelpers.interopDefault(_sweetalert);
...
class Register {
  ...
  _register() {
    ...
    amountField.addEventListener('focus', e => {
      if (this.#undefined === 'Tier One') {
        e.target.value = 1000;
      }
      if (this.#undefined === 'Tier Two') {
        e.target.value = 5000;
      }
      if (this.#undefined === 'Tier Three') {
    ...
    btnRegister.addEventListener('click', e => {
      ...
      this.#undefined === 'Tier One' ? bvn = null : bvn = bvnField.value;
      ...
      if (this.#undefined === 'Tier One' && amount !== 1000) {
        _sweetalertDefault.default.fire({
          title: 'Error',
      ...
      if (this.#undefined === 'Tier Two' && amount !== 5000) {
        _sweetalertDefault.default.fire({
          title: 'Error',
      ...
      if (this.#undefined === 'Tier Three' && amount !== 20000) {
        _sweetalertDefault.default.fire({
          title: 'Error',
      ...
      const required = fullName !== '' && mobile !== '' && userName !== '' && amount !== '' && password !== '';
      const authUser = () => {
        ...
        // Clear input fields
        fullNameField.value = mobileField.value = userNameField.value = amountField.value = passwordField.value = bvnField.value = '';
      ...
      if (this.accounts.length > 0) {
        userNameExist = this.accounts.map(acc => acc.userName).some(user => userNameField.value === user);
      }
      if (userNameExist) {
        // if yes Alart Error
        _sweetalertDefault.default.fire({
...
},{"sweetalert2":"65nX0","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"65nX0":[function(require,module,exports) {
var define;
/*!
...
},{}],"3zElt":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "Account", function () {
  return Account;
});
// @ts-nocheck
...
class Account {
  ...
  calcSumary(acct) {
    const income = acct.movements.filter(mov => mov > 0).reduce((acc, cur) => acc + cur, 0);
    labelSumIn.textContent = `${income}€`;
    const outcome = acct.movements.filter(mov => mov < 0).reduce((acc, cur) => acc + cur, 0);
    labelSumOut.textContent = `${Math.abs(outcome)}€`;
    const interest = acct.movements.filter(mov => mov > 0).map(int => int * acct.interestRate / 100).filter(int => int >= 1).reduce((acc, cur) => acc + cur, 0);
